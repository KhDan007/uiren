export const Button = () => {
  return (
    <section className="button pb-8 px-3">
      <h1 className="text-center font-semibold pb-8 text-4xl ">Присоеденияйтесь!</h1>
      <div className="flex text-lg md:text-xl font-PublicSans mx-auto max-w-lg justify-between">
        ...
        <div className="bg-blue-500 text-white cursor-pointer button__student ml-3 px-6 py-4 transition rounded-3xl hover:bg-slate-500">
          Зайти как студент
        </div>
      </div>
    </section>
